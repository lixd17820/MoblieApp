...
import com.jwt.bean.BluetoothBean;
import com.jwt.utils.ClsUtils;
...
public class ConfigBluetoothActivity extends ActionBarListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String defPrinterName = GlobalSystemParam.getSavedInfo(this, GlobalConstant.GRXX_PRINTER_NAME);
        String defCardReader = GlobalSystemParam.getSavedInfo(this, GlobalConstant.GRXX_CARD_READER_NAME);
    ...
    private int saveCardReader(String name, String address) {
        GlobalSystemParam.putSavedInfo(this, GlobalConstant.GRXX_CARD_READER_NAME, name);
        GlobalSystemParam.putSavedInfo(this, GlobalConstant.GRXX_CARD_READER_ADDRESS, address);
        return 1;
    }

    private int setupPrinter(String name, String address) {
        GlobalSystemParam.putSavedInfo(this, GlobalConstant.GRXX_PRINTER_NAME, name);
        GlobalSystemParam.putSavedInfo(this, GlobalConstant.GRXX_PRINTER_ADDRESS, address);
        return 1;
    }
