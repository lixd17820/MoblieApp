...
@Entity
public class AcdSimpleBean implements Serializable{
	...
	public String getTjr1() {
		return tjr1;
	}

	public void setTjr1(String tjr1) {
		this.tjr1 = tjr1;
	}
	...
	public void setCclrsj(String cclrsj) {
		this.cclrsj = cclrsj;
	}
	...
	public String getScsjd() {
		return scsjd;
	}

	public void setScsjd(String scsjd) {
		this.scsjd = scsjd;
	}
