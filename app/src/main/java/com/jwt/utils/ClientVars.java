...
public final class ClientVars {
    ...
    public static final int receivefromcardOk = 3;
    ...
    public static final int checkSAM = 0x01;//11FF SAM_V状
    public static final int readSAMSN = 0x02;//12FF 读SAM_V管理信息
    public static final int seachCard = 0x03;//2001  寻找身份
    public static final int selectCard = 0x04;//2002  选取身份
    public static final int readBaseInfo = 0x05;//3001  读基本信
    public static final int readAllInfo = 0x06;//3010  读基本信息和证载指纹信息
    public static final int readAddressAdd = 0x07;//3003  读追加地
    ...
    //服务读卡
    public static final int readAllInfoOk = 6;//3010  读基本信息和证载指纹信息
