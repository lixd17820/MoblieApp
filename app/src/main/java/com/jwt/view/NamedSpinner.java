...
public class NamedSpinner extends LinearLayout {
    ...
    public NamedSpinner(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.NamedSpinner, defStyleAttr, defStyleRes);
...
//        }
    ...
    public void setAdapter(SpinnerCustomAdapter adapter) {
        mSpinner.setAdapter(adapter);
    }

    public SpinnerCustomAdapter getAdapter() {
        return (SpinnerCustomAdapter) mSpinner.getAdapter();
    }
    ...
    public String getSelectKey(){
       KeyValueBean kv = (KeyValueBean) mSpinner.getSelectedItem();
       if(kv != null){
           return kv.getKey();
       }
       return "";
